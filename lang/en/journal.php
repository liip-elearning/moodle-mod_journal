...
$string['time_limit'] = 'Student edition time limit';
$string['end_date'] = 'End date';
$string['end_date_help'] = 'End date help';
$string['end_date_help_help'] = 'After this time the journal will be read-only to students but editable for teachers';
$string['timesup'] = 'You cannot add/edit your entry anymore.';
